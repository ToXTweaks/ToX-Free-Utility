...
namespace ToX_Free_Utility.LoadingForms
{
    public partial class TweaksSuccess : Form
    {
        ...
        public static async Task ShowModal(Form parent, TweaksSuccess modalForm)
        {
