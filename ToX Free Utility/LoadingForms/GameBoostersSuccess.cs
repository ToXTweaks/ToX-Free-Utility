...
namespace ToX_Free_Utility.LoadingForms
{
    public partial class GameBoostersSuccess : Form
    {
        ...
        public static async Task ShowModal(Form parent, GameBoostersSuccess modalForm)
        {
        ...
        // Close button click event for gradient button
