...
namespace ToX_Free_Utility.LoadingForms
{
    public partial class UninstallJunkLoading : Form
    {
        ...
        public static async Task ShowModal(Form parent, UninstallJunkLoading modalForm)
        {
